 ...
 * @author Anderson
 */
public class TelaConsultarObra extends javax.swing.JFrame {

    /**
     * Creates new form TelaAlterarObras
     */
    public TelaConsultarObra() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        butonCancelar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butonCancelarActionPerformed(evt);
            }
        });

        jLabel1.setText("Selecione uma obra para consultar");
    ...
    private void butonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butonCancelarActionPerformed
        TelaConsultarObra.this.dispose();
