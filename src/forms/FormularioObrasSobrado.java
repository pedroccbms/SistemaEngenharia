 ...
 * @author Maxximus
 */
public class FormularioObrasSobrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTipoSobrado.setText("Tipo do Sobrado");

        labelLaje.setText("Laje?");

        labelReboco.setText("Reboco?");

        tipoDoSobrado.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Salão" }));
    ...
    public void preencherCampo() throws Exception{
        try {
            PreparedStatement pst = conecta.conn.prepareStatement("Insert into obra (nome_obra)values(?)");/*data_inicio, data_termino, tipo_obra, obra_metro*/
